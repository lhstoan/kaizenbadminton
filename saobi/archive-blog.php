...
<main> 
	...
	<div id="content">
		<div id="swup">
			<div id="top_info">
                <div class="inner">
                    <p class="en anim fancy_title wow fadeInUp">BLOG</p>
                    <h2 class="anim fancy_title wow fadeInUp"><?php if(isset($GLOBALS['h2'])){echo $GLOBALS['h2'];} ?></h2>
                </div>
            </div>
			<!-- #topic_path -->
			<div id="topic_path">
				<div class="inner clearfix">
					<ul>
						...
						<?php if ( $year || $monthnum || $day ) {?>
							<li><a class="anim fancy_title wow fadeInUp" href="<?php echo home_url();?>/blog/">ブログ</a></li>
							<li class="anim fancy_title wow fadeInUp">
								<?php echo $year.'年'.$monthnum.'月'.($day ? $day.'日':''); ?>
							</li>
						<?php } else { ?>
							<li class="anim fancy_title wow fadeInUp">ブログ</li>
						<?php } ?>
					</ul>
				</div>
			</div>
						...
						<div class="sidebar">
							...
							<ul class="list01">
							    ...
							    foreach ($monthly_counts as $year_month => $count) {
							        ...
							        ?>
							        <li>
							            <a href="<?php echo home_url('blog') . "/$year/$month/"; ?>"><?php echo $year."年".$month."月"."(".$count.")"; ?></a>
							        </li>
							        <?php
							    }
							    ?>
