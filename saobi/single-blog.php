      ...
      <div class="inner clearfix"> 
        ...
        <section class="clearfix blog_detail wpContent">
          <h3><span class="tt_h3"><?php echo get_the_title(); ?></span></h3>
					...
					<p class="center blog_img"><img src="<?php echo get_field('blog_img')['url']; ?>" alt="<?php echo strip_tags( get_the_title() ); ?>"></p>
					<?php endif; ?>
          <?php the_content(); ?>
          ...
          <ul class="blog_btn">
            ...
            <li class="btn_back"><a href="<?php echo home_url(); ?>/blog/" class="view-list">一覧</a></li>
						<li class="nextPage">
            <?php if($next_post) { ?>
