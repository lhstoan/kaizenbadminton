...
function prefix_register_all() {
 /* ========================================================================= */
  ...
  $name = "Competitor";
    ...
    $menu_name = "Competitor";
    $name_admin_bar = "Competitor";
    $all_items = "All Items";
    $add_new = "Add New";
    $add_new_item = "Add New Item";
    $edit_item = "Edit Item";
  ...
  register_post_type(
    ...
    array(
      'labels' => array(
        ...
        'name_admin_bar' => __( $name_admin_bar, 'text_domain' ),
        'all_items' => __( $all_items, 'text_domain' ),
        'add_new' => _x( $add_new, 'competitor', 'text_domain' ),
        'add_new_item' => __( $add_new_item, 'text_domain' ),
        'edit_item' => __( $edit_item, 'text_domain' ),
        'new_item' => __( $new_item, 'text_domain' ),
        'view_item' => __( $view_item, 'text_domain' ),
  ...
  register_post_type(
    ...
    array(
      'labels' => array(
        ...
        'name_admin_bar' => __( $name_admin_bar, 'text_domain' ),
        'all_items' => __( $all_items, 'text_domain' ),
        'add_new' => _x( $add_new, 'collections', 'text_domain' ),
        'add_new_item' => __( $add_new_item, 'text_domain' ),
        'edit_item' => __( $edit_item, 'text_domain' ),
        'new_item' => __( $new_item, 'text_domain' ),
        'view_item' => __( $view_item, 'text_domain' ),
